// Modified from: https://github.com/mozilla/blok/blob/master/src/js/canonicalize.js

/* eslint no-unused-vars: ["error", { "varsIgnorePattern": "(EXPORTED_SYMBOLS|canonicalizeHost)" }]*/

const EXPORTED_SYMBOLS = ["canonicalizeHost"];
